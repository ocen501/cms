                     ...
                     <script type="text/javascript">
                      ...
                      function drawChart() {
                        var data = google.visualization.arrayToDataTable([
                          ...
                          <?php 
                          $elements_text = ['All Post','Active Posts','Draft Posts', 'Comments', 'Pending comements','Users', 'Subscribers', 'Categories'];
                          $elements_count = [$post_count,$post_published_count, $post_draft_count, $comment_count, $unapproved_comment_count, $users_count, $subscribers_count, $categories_count];
